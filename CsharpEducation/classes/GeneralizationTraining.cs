...
namespace Education.classes
{
    class GeneralizationTraining : ITask
    {
        public static void OutTask()
        {
            ...
            Console.WriteLine("Использование нескольких универсальных параметров, обобщенных классов");
            Console.WriteLine("where T(некоторый_тип) : тип_ограничения");
            Console.WriteLine("Какие есть ограничения для классов: ");
            Console.WriteLine(
                "Классы\n" +
                "Интерфейсы\n" +
