    ...
    class StringStringBuilderRegexTraining : ITask
    {
        public static void OutTask()
        {
            Console.WriteLine("---- Работа со строками ----\n" +
                ...
                "" +
                "2.Изучение объекта StringBuilder" +
                "Это объект, который является изменяемым(в отличие от string),\n" +
                "а также для инициализации можно указывать количество символов.Тем самым повышает производительность\n" +
                "Его методы:\n" +
                "Insert, Remove, Replace, AppendFormat" +
                "Когда нужно использовать обычный string:\n" +
                "-При небольшом количестве операций и изменений над строками\n" +
                "-При выполнении фиксированного количества операций объединения.\n" +
                "В этом случае компилятор может объединить все операции объединения в одну\n" +
                ...
                "Когда нужно использовать StringBuilder:\n" +
